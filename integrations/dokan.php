...
class Dokan extends IntegrationBase {
	...
	public static function get_triggers(): array {
		return [
			...
			'vendor_update'           => [
				'label' => 'Vendor Updated (before update)',
	...
	public static function get_trigger_sample_output( string $trigger ): array {
		...
		$samples = [
			...
			'withdraw_request_approved'   => [
				...
				'withdraw_id' => 21,
				'vendor_id'   => 3,
				'withdraw'    => array_merge( $withdraw_sample, [
					'status' => 'approved',
					'status_code' => 1
				] ),
			],
			...
			'refund_request'              => array_merge( [
				'event' => $trigger,
				'event_time' => $event_time
			], $refund_sample ),
			'refund_approved'             => array_merge( [
				'event' => $trigger,
				'event_time' => $event_time
			], $refund_sample ),
			'refund_cancelled'            => array_merge( [
				'event' => $trigger,
				'event_time' => $event_time
			], $refund_sample ),
		];
