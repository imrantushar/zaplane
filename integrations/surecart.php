...
class Surecart extends IntegrationBase {
    ...
    public static function get_slug(): string { return 'surecart'; }
    ...
    public static function get_triggers(): array {
        return [
            'purchase_created' => ['label'=>'Purchase Created','hook'=>'surecart/purchase_created'],
            'purchase_invoked' => ['label'=>'Purchase Invoked','hook'=>'surecart/purchase_invoked'],
            'purchase_revoked' => ['label'=>'Purchase Revoked','hook'=>'surecart/purchase_revoked'],
            'checkout_confirmed' => ['label'=>'Checkout Confirmed','hook'=>'surecart/checkout_confirmed'],
            'product_sync_created' => ['label'=>'Product Synced (Created)','hook'=>'surecart/product/sync/created'],
            'product_sync_updated' => ['label'=>'Product Synced (Updated)','hook'=>'surecart/product/sync/updated'],
            'integrations_created' => ['label'=>'Integrations Created','hook'=>'surecart/integrations/create'],
            'integrations_deleted' => ['label'=>'Integrations Deleted','hook'=>'surecart/integrations/delete'],
            'help_widget_loaded' => ['label'=>'Help Widget Loaded','hook'=>'surecart/help_widget/loaded'],
            'admin_coupons_edit' => ['label'=>'Admin Coupons Edit','hook'=>'surecart/admin/coupons/edit'],
            'post_created' => ['label'=>'Post Created (PageService)','hook'=>'surecart/post_created'],
        ];
    }
    ...
    public static function get_action_config_schema( string $action ): array {
        $schemas = [
            ...
            'create_product_manual' => [
                ...
                ['key'=>'price_amount','label'=>'Price Amount (minor unit)','type'=>'number','required'=>true],
                ['key'=>'currency','label'=>'Currency (ISO)','type'=>'text','required'=>true],
                ['key'=>'recurring_interval','label'=>'Recurring Interval','type'=>'select','options'=>[
                    ['label'=>'Day','value'=>'day'],
                    ['label'=>'Week','value'=>'week'],
                    ['label'=>'Month','value'=>'month'],
                    ['label'=>'Year','value'=>'year'],
                ]],
                ['key'=>'recurring_interval_count','label'=>'Recurring Interval Count','type'=>'number','default'=>1],
                ...self::field_mode(),
                ...self::field_expand(),
            ],
            'create_product' => [
