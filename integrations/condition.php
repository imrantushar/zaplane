...
class Condition extends IntegrationBase {
	...
	public static function get_slug(): string { return 'condition'; }
	public static function get_name(): string { return 'Condition'; }
	public static function get_icon(): string { return 'condition'; }
