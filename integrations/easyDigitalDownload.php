...
class Easydigitaldownload extends IntegrationBase {
    ...
    public static function get_triggers(): array
    {
        return [
            ...
            'payment_status_changed' => ['label' => 'Payment Status Changed', 'hook' => 'edd_before_payment_status_change'],
            'customer_created' => ['label' => 'Customer Created', 'hook' => 'edd_customer_post_create'],
            'customer_updated' => ['label' => 'Customer Updated', 'hook' => 'edd_customer_post_update'],
            'customer_deleted' => ['label' => 'Customer Deleted', 'hook' => 'edd_customer_destroyed'],
            'discount_created' => ['label' => 'Discount Created', 'hook' => 'edd_post_insert_discount'],
            'discount_updated' => ['label' => 'Discount Updated', 'hook' => 'edd_post_update_discount'],
            'discount_deleted' => ['label' => 'Discount Deleted', 'hook' => 'edd_post_delete_discount'],
            'download_created' => ['label' => 'Product Created', 'hook' => 'wp_insert_post'],
            'download_updated' => ['label' => 'Product Updated', 'hook' => 'save_post_download'],
            'download_deleted' => ['label' => 'Product Deleted', 'hook' => 'before_delete_post'],
            'download_purchased' => ['label' => 'Product Purchased (Item)', 'hook' => 'edd_complete_download_purchase'],
        ];
    }
public static function resolve_trigger(array $node, array $args) {
    ...
    // Triggers are handled in TriggersTrait (WordPress-style)
    ...
    public static function get_action_config_schema( string $action ): array {
        $schemas = [
            ...
            'update_payment_status' => [
                ['key' => 'payment_id', 'label' => 'Payment ID', 'type' => 'number', 'required' => true],
                ['key' => 'status', 'label' => 'Status', 'type' => 'select', 'options' => [
            ...
            'update_download' => [
                ['key' => 'download_id', 'label' => 'Product ID', 'type' => 'number', 'required' => true],
            ...
            'delete_download' => [
                ['key' => 'download_id', 'label' => 'Product ID', 'type' => 'number', 'required' => true],
                ['key' => 'force_delete', 'label' => 'Force Delete', 'type' => 'select', 'options' => [
                    ['label' => 'No', 'value' => '0'],
                    ['label' => 'Yes', 'value' => '1'],
                ]],
            ],
    ...
    // resolve_trigger handled in TriggersTrait
