...
class woocommerce extends IntegrationBase {
    ...
    public static function get_action_config_schema( string $action ): array {
        $schemas = [
            // Orders
            'create_order' => [
                ['key'=>'customer_id','label'=>'Customer ID','type'=>'expression'],
                ['key'=>'status','label'=>'Order Status','type'=>'select','options'=>self::order_status_options()],
                ['key'=>'currency','label'=>'Currency','type'=>'text'],
                ['key'=>'note','label'=>'Order Note','type'=>'textarea'],
                ['key'=>'is_customer_note','label'=>'Customer Note','type'=>'boolean'],
            ],
            'update_order' => [
                ...self::field_order_id(),
                ['key'=>'status','label'=>'Order Status','type'=>'select','options'=>self::order_status_options()],
                ['key'=>'customer_id','label'=>'Customer ID','type'=>'expression'],
                ['key'=>'total','label'=>'Order Total','type'=>'expression'],
                ['key'=>'currency','label'=>'Currency','type'=>'text'],
                ['key'=>'billing','label'=>'Billing Data (JSON)','type'=>'textarea'],
                ['key'=>'shipping','label'=>'Shipping Data (JSON)','type'=>'textarea'],
                ['key'=>'meta','label'=>'Meta (JSON)','type'=>'textarea'],
                ['key'=>'data','label'=>'Order Data (JSON)','type'=>'textarea'],
            ],
            'update_order_status' => [
                ...self::field_order_id(),
                ['key'=>'status','label'=>'Order Status','type'=>'select','options'=>self::order_status_options(),'required'=>true],
            ],
            ...
            'get_orders_by_billing_email' => [
                ['key'=>'billing_email','label'=>'Billing Email','type'=>'text','required'=>true],
                ...self::field_limit_page(),
            ],
            ...
            'get_customer_by_email' => [
                ['key'=>'email','label'=>'Customer Email','type'=>'text','required'=>true],
            ],
            'create_customer' => [
            ...
            'create_product' => [
                ...
                ['key'=>'status','label'=>'Status','type'=>'select','options'=>self::product_status_options()],
                ['key'=>'sku','label'=>'SKU','type'=>'text'],
                ['key'=>'regular_price','label'=>'Regular Price','type'=>'expression'],
                ['key'=>'sale_price','label'=>'Sale Price','type'=>'expression'],
                ['key'=>'price','label'=>'Price','type'=>'expression'],
                ['key'=>'description','label'=>'Description','type'=>'textarea'],
                ['key'=>'short_description','label'=>'Short Description','type'=>'textarea'],
                ['key'=>'stock_quantity','label'=>'Stock Quantity','type'=>'expression'],
                ['key'=>'manage_stock','label'=>'Manage Stock','type'=>'boolean'],
                ['key'=>'stock_status','label'=>'Stock Status','type'=>'select','options'=>self::stock_status_options()],
                ['key'=>'category_ids','label'=>'Category IDs (CSV/JSON)','type'=>'textarea'],
                ['key'=>'tag_ids','label'=>'Tag IDs (CSV/JSON)','type'=>'textarea'],
            ],
            'create_product_variation' => [
                ['key'=>'parent_id','label'=>'Parent Product ID','type'=>'expression','required'=>true],
                ['key'=>'attributes','label'=>'Attributes (JSON)','type'=>'textarea','required'=>true],
                ['key'=>'sku','label'=>'SKU','type'=>'text'],
                ['key'=>'regular_price','label'=>'Regular Price','type'=>'expression'],
                ['key'=>'sale_price','label'=>'Sale Price','type'=>'expression'],
                ['key'=>'stock_quantity','label'=>'Stock Quantity','type'=>'expression'],
            ...
            'update_product' => [
                ...
                ['key'=>'category_ids','label'=>'Category IDs (CSV/JSON)','type'=>'textarea'],
                ['key'=>'tag_ids','label'=>'Tag IDs (CSV/JSON)','type'=>'textarea'],
                ['key'=>'data','label'=>'Product Data (JSON)','type'=>'textarea'],
            ],
            'get_products_all' => [
                ...self::field_limit_page(),
            ],
            'get_products_by_category' => [
                ['key'=>'category_id','label'=>'Category ID','type'=>'expression'],
            ...
            'update_product_status' => [
                ...self::field_product_id(),
                ['key'=>'status','label'=>'Status','type'=>'select','options'=>self::product_status_options(),'required'=>true],
            ],

            // Categories/Tags/Types/Brands/Shipping Classes
            ...
            'add_or_update_product_attribute' => [
                ...
                ['key'=>'options','label'=>'Options (CSV/JSON)','type'=>'textarea'],
                ['key'=>'visible','label'=>'Visible on Product Page','type'=>'boolean'],
                ['key'=>'variation','label'=>'Used for Variations','type'=>'boolean'],
                ['key'=>'is_taxonomy','label'=>'Taxonomy Attribute','type'=>'boolean'],
                ['key'=>'taxonomy','label'=>'Taxonomy (e.g. pa_color)','type'=>'text'],
            ...
            'add_product_to_cart' => [
                ...
                ['key'=>'variation_id','label'=>'Variation ID','type'=>'expression'],
                ['key'=>'variations','label'=>'Variations (JSON)','type'=>'textarea'],
                ['key'=>'cart_item_data','label'=>'Cart Item Data (JSON)','type'=>'textarea'],
            ],
            'remove_product_from_cart' => [
                ['key'=>'cart_item_key','label'=>'Cart Item Key','type'=>'text','required'=>true],
            ],

            // Coupons
            'create_coupon' => [
                ['key'=>'code','label'=>'Coupon Code','type'=>'text','required'=>true],
                ['key'=>'discount_type','label'=>'Discount Type','type'=>'select','options'=>self::coupon_type_options()],
                ['key'=>'amount','label'=>'Amount','type'=>'expression'],
                ['key'=>'usage_limit','label'=>'Usage Limit','type'=>'expression'],
                ['key'=>'expiry_date','label'=>'Expiry Date','type'=>'date'],
                ['key'=>'email_restrictions','label'=>'Email Restrictions (CSV/JSON)','type'=>'textarea'],
                ['key'=>'product_ids','label'=>'Product IDs (CSV/JSON)','type'=>'textarea'],
                ['key'=>'exclude_product_ids','label'=>'Exclude Product IDs (CSV/JSON)','type'=>'textarea'],
            ],
            'update_coupon_data' => [
                ...
                ['key'=>'product_ids','label'=>'Product IDs (CSV/JSON)','type'=>'textarea'],
                ['key'=>'exclude_product_ids','label'=>'Exclude Product IDs (CSV/JSON)','type'=>'textarea'],
                ['key'=>'data','label'=>'Coupon Data (JSON)','type'=>'textarea'],
            ],
            'update_coupon_code' => [
                ...self::field_coupon_identifier(),
                ['key'=>'new_code','label'=>'New Coupon Code','type'=>'text','required'=>true],
            ],
            'add_coupon_emails' => [
                ...self::field_coupon_identifier(),
                ['key'=>'emails','label'=>'Emails (CSV/JSON)','type'=>'textarea','required'=>true],
            ],
