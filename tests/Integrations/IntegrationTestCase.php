...
abstract class IntegrationTestCase extends TestCase
{
    ...
    protected function setupMockData(): void
    {
        ...
        WPMocks::setPost(1, ['post_title' => 'Test Post', 'post_type' => 'post']);
        WPMocks::setPost(2, ['post_title' => 'Test Page', 'post_type' => 'page']);
        WPMocks::setPost(3, ['post_title' => 'Test Attachment', 'post_type' => 'attachment', 'post_mime_type' => 'image/jpeg']);
        WPMocks::setUser(1, ['user_login' => 'admin', 'user_email' => 'admin@example.com']);
        WPMocks::setUser(2, ['user_login' => 'testuser', 'user_email' => 'test@example.com']);
        WPMocks::setComment(1, ['comment_content' => 'Test comment', 'comment_post_ID' => 1]);
    ...
    protected function getDefaultTriggerArgs(string $event): array
    {
        $defaults = [
            ...
            'delete_user' => [1],
            'wp_login' => ['admin', (object)['ID' => 1, 'user_login' => 'admin', 'user_email' => 'admin@example.com', 'roles' => ['administrator']]],
    ...
    protected function getDefaultActionConfig(string $event): array
    {
        $defaults = [
            // Post actions
            'create_post' => ['post_title' => 'Test', 'post_type' => 'post', 'post_status' => 'draft'],
            'update_post' => ['post_id' => 1, 'post_title' => 'Updated', 'post_content' => 'Content', 'post_type' => 'post'],
            'update_title' => ['post_id' => 1, 'post_title' => 'New Title', 'post_type' => 'post'],
            'trash_post' => ['post_id' => 1, 'post_type' => 'post'],
            'delete_post' => ['post_id' => 1, 'post_type' => 'post'],
            'get_post_single' => ['post_id' => 1],

            // User actions
            'create_user' => ['user_login' => 'newuser', 'user_email' => 'new@example.com', 'user_pass' => 'pass123'],
            'update_user' => ['user_id' => 1, 'display_name' => 'Updated Name'],
            'delete_user' => ['user_id' => 2],
            'get_user_by_id' => ['user_id' => 1],

            // Comment actions
            'create_comment' => ['post_id' => 1, 'author_name' => 'Test', 'author_email' => 'test@example.com', 'content' => 'Comment'],
