...
class CustomAppsController extends WP_REST_Controller {
	...
	public function create_item( $request ) {
		...
		// Only the app is saved here — no workflow is created. The new app shows up
		// in the Workflows builder on its own, so users create workflows when they
		// actually want one rather than getting an unwanted draft per app.
